	    ...
	    render: function render() {
	        ...
	        if (this.state.visible || !this.state.destroyOnClose) {
	            ...
	            dialog = _react2.default.createElement(
	                ...
	                { visible: this.state.visible, wrapClassName: wrapClassName, animation: 'zoom', maskAnimation: 'fade', onClose: this.onClose, style: style, mousePosition: this.state.mousePosition },
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    null,
	                    'center',
	                    _react2.default.createElement('input', { type: 'checkbox', checked: this.state.center, onChange: this.center })
	                )
	            ),
	            dialog
	        );
