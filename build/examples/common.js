...
/***/ function(module, exports, __webpack_require__) {
	...
	var ____Class0=React.Component;for(var ____Class0____Key in ____Class0){if(____Class0.hasOwnProperty(____Class0____Key)){DialogWrap[____Class0____Key]=____Class0[____Class0____Key];}}var ____SuperProtoOf____Class0=____Class0===null?null:____Class0.prototype;DialogWrap.prototype=Object.create(____SuperProtoOf____Class0);DialogWrap.prototype.constructor=DialogWrap;DialogWrap.__superConstructor__=____Class0;
	  Object.defineProperty(DialogWrap.prototype,"getDialogContainer",{writable:true,configurable:true,value:function() {"use strict";
	  ...
	  function DialogWrap(props) {"use strict";
	  ...
	  Object.defineProperty(DialogWrap.prototype,"componentWillReceiveProps",{writable:true,configurable:true,value:function(props) {"use strict";
	  ...
	  Object.defineProperty(DialogWrap.prototype,"close",{writable:true,configurable:true,value:function() {"use strict";
	    if (this.state.visible) {
	      var props = this.props;
	      this.setState({
	        visible: false
	  ...
	  Object.defineProperty(DialogWrap.prototype,"requestClose",{writable:true,configurable:true,value:function() {"use strict";
	    if (this.props.onBeforeClose(this) !== false) {
	      this.close();
	    }
	  }});

	  Object.defineProperty(DialogWrap.prototype,"renderDialog",{writable:true,configurable:true,value:function() {"use strict";
	    var props = this.props;
	    var dialogProps = copy(props, ['className', 'closable', 'align',
	      'prefixCls', 'style', 'width', 'height', 'zIndex']);
	    var dialogElement = React.createElement(Dialog, React.__spread({
	  ...
	  Object.defineProperty(DialogWrap.prototype,"render",{writable:true,configurable:true,value:function() {"use strict";
	    return null;
	  }});

	  Object.defineProperty(DialogWrap.prototype,"componentDidMount",{writable:true,configurable:true,value:function() {"use strict";
	  ...
	  Object.defineProperty(DialogWrap.prototype,"componentDidUpdate",{writable:true,configurable:true,value:function() {"use strict";
	    if (this.dialogInstance || this.state.visible) {
	      this.renderDialog();
	    }
	  }});

	  Object.defineProperty(DialogWrap.prototype,"componentWillUnmount",{writable:true,configurable:true,value:function() {"use strict";
	    if (this.dialogContainer) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dialog = React.createClass({displayName: "Dialog",
	  ...
	  unMonitorWindowResize:function() {
	    if (this.resizeHandler) {
	      ...
	      React.createElement("div", {className: [prefixClsFn(prefixCls, ''), props.className].join(' '), tabIndex: "0", role: "dialog", ref: "dialog", style: style}, 
	        React.createElement("div", {className: prefixClsFn(prefixCls, 'content')}, 
	          React.createElement("div", {className: prefixClsFn(prefixCls, 'header')}, 
	            closable ?
	              (React.createElement("a", {tabIndex: "0", onClick: this.props.onClose, className: [prefixClsFn(prefixCls, 'close')].join('')}, 
	                React.createElement("span", {className: prefixClsFn(prefixCls, 'close-x')}, "×")
	              )) :
	              null, 
	            React.createElement("div", {className: prefixClsFn(prefixCls, 'title')}, props.title)
	          ), 
	          React.createElement("div", {className: prefixClsFn(prefixCls, 'body')}, props.children)
	        )
	      )
	    ));
	  }
